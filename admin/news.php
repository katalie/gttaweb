...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<form method="get" action="news.php" style="margin: 0"><input
			type="hidden" name="cid" value="<?php echo $cid;?>">
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			class="serach">
			<tr>
				<td width="70" height="40" align="right">Keyword:  </td>
				<td width="135" style="padding-left: 2px"><input title="Please Input News' Title or Content"
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			class="table_head">
			<tr>
				<td width="200" height="31">News Management</td>
				<td align="right"><select name="select"
					onChange="window.location.href='news.php?cid='+this.value">
					<option value="0">--All Categories--</option>
              <?php getCategorySelect ("category",$cid)?>
                    </select> <input type="button" value="Add News"
					onClick="location.href='news.add.php?act=add&cid=<?php echo $cid;?>'"
					class="submit"></td>
			</tr>
		</table>
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
        ...
        <tr onMouseOver="this.className='relow'"
				...
				<td height="26"><a
					href="news.add.php?act=edit&id=<?php echo $al ['id'];?>&cid=<?php echo $al ['cid'];?>"> <?php echo $al ['title'];?> </a>&nbsp;</td>
				<td height="26" align="center"><?php echo $al ['created_date'];?> &nbsp;</td>
				<td align="center"><?php echo $al ['name'];?> &nbsp;</td>
				<td align="center"><?php echo $al['slide_position']?"<font color='#ff00000'>".$al['slide_position']."</font>":"Not Available";?>&nbsp;</td>
				<td height="26" align="center"><a
					href="news.add.php?act=edit&cid=<?php echo $al['cid'];?>&id=<?php echo $al ['id'];?>"><img
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
                ...
                <?php getCategorySelect ("category");?>
