...
$sql_string = "select * from file order by id desc";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr>
    <td valign="top" style="padding:10px;"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_head">
        <tr>
          <td width="200" height="30">File Management
            &nbsp;&nbsp;&nbsp;</td>
          <td>
          <form action="file.action.php" method="post" enctype="multipart/form-data" style="margin:0">
          <input type="hidden" name="act" value="add">
          <input type="file" name="file" id="file">
          <input name="button" type="submit" class="submit1" id="button" value="Upload">
          </form>
          </td>
        </tr>
      </table>
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_form">
        <tr>
          ...
          <th width="54" height="26">Operations</th>
        </tr>
        <?php
  ...
  ?>
        <tr onMouseOver="this.className='relow'" onMouseOut="this.className='row'" class="row">
          ...
          <td align="center" >
          <img src="../<?php echo $list['path'];?>" width="50" height="50" onMouseOver="document.getElementById('bigPic<?php echo $list['id'];?>').style.display=''" onMouseOut="document.getElementById('bigPic<?php echo $list['id'];?>').style.display='none'">
          <div id="bigPic<?php echo $list['id'];?>" style="display:none; position:absolute;"><img src="../<?php echo $list['path'];?>"></div>
          </td>
          <td align="center" >http://www.lijuangeng.com<?php echo $list['path_origin'];?>&nbsp;</td>
          <td align="center" ><?php echo round($list['size']/1024,2);?> K</td>
          <td align="center"><?php echo $list['upload_date'];?>&nbsp;</td>
          <td height="40" align="center"><a href="page.add.php?act=edit&id=<?php echo $list['id'];?>"></a> <img src="images/del.gif" alt="Delete" onClick="doAction('delete',<?php echo $list['id'];?>)" style="cursor:pointer"></td>
        </tr>
        <?php
	}
  ?>
