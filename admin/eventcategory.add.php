...
if($act=='edit'){
	$classify_row = $db->find("select * from category_event where id=".$id);
...
<body>
<form action="eventcategory.action.php" method="post">
<input type="hidden" name="act" value="<?php echo $act;?>">
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form_title">
  <tr>
    <td width="39%" height="31"><?php echo $actName;?> Event Category</td>
...
<table width="100%" border="0" align="center" cellpadding="5"
	...
	<tr class="row">
      ...
      <?php getCategorySelect_event($pid)?>
      </select>      </td>
    </tr>
	<tr class="row">
