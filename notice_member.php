...
<li><a href="#tabs-2">Member Exclusive Notices</a></li>
<li><a href="#tabs-3">Monthly Ratings</a></li>
</ul>
<div id="tabs-1">
...
<div id="tabs-2">
<marquee scrollamount="4" scrolldelay="10" direction="up" onmouseover="this.stop()" onmouseout="this.start()">
	<?php $notice_list = $db->findAll("select * from notice where state=0 and is_member=1 order by id LIMIT 0,30 ");
	foreach($notice_list as $list){?>
	<div><a href="notice.php?id=<?php echo $list ['id'];?>" target="_blank"><?php echo $list['title']?>..</a></div>
	</br>
	<?php }?>
